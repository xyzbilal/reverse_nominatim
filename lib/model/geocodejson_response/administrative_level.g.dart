...
part of 'administrative_level.dart';
...
Map<String, dynamic> _$AdministrativeLevelToJson(
        AdministrativeLevel instance) =>
    <String, dynamic>{
      ...
      'level9': instance.level9,
      'level10': instance.level10,
    };
